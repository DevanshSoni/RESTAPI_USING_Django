"""
Django settings for techAPI project.
...
SECRET_KEY = 'i1ao0c=)kqkfq%ot^fehci2rx2-!&ldj3f^bzq9f8x691+2mv='
...
WSGI_APPLICATION = 'techAPI.wsgi.application'
